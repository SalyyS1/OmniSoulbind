package com.salyvn.omnisoulbind.util
...
object TextUtil {
    ...
    /** Plain text of an already-rendered component (for lore comparison). */
    fun plainOf(component: Component): String = plain.serialize(component)
